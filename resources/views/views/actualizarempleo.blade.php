...
<head>
  ...
  <body>
    <div class="contact-form">
        ...
        <h2>Actualizar Empleo</h2>
        <form method="post">   
    <div class="form-group">
    </br>
    <input type="text" name="nombre" class="form-control" value ="{!!$empleo->nombre!!}" />
   </div>
   <div class="form-group">
    </br>
    <input type="text" name="descripcion" class="form-control" value ="{!!$empleo->descripcion!!}" />
   </div>
   <div class="form-group">
